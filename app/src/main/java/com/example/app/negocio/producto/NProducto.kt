...
class NProducto(context: Context) {
    ...
    fun modificar(id: Int, nombre: String, descripcion: String, precio: Double, stock: Int): Boolean {
    ...
    fun tieneMovimientos(id: Int): Boolean = dProducto.existeMovimientos(id)

    fun eliminarForzado(id: Int): Boolean {
        dProducto.setId(id)
        return dProducto.eliminarForzado()
    }
